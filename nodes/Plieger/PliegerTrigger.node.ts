...
export class PliegerTrigger implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'Plieger Trigger',
        name: 'pliegerTrigger',
        icon: { light: 'file:plieger.svg', dark: 'file:plieger.svg' },
        group: ['trigger'],
        version: 1,
        description: 'Start de workflow wanneer er iets gebeurt in Plieger',
        defaults: {
            name: 'Plieger Trigger',
        },
        inputs: [],
    ...
    methods = {
        loadOptions: {
            async getModels(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
                ...
                const baseUrl = credentials.baseUrl as string;
                const accessToken = await PliegerTrigger.getAccessToken(this, credentials);
