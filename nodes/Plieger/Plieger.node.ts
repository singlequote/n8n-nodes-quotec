...
import { pliegerOperations, pliegerFields } from './descriptions/Plieger.description';
...
export class Plieger implements INodeType {
        ...
        properties: [
            ...
            // ----------------------------------
            {
                ...
                options: [
                    ...
                    {
                        name: 'Plieger Sanitairkiezer',
                        value: 'plieger',
                    }
                ],
                default: 'plieger', // Changed from assignments to plieger to match the resource options
            },
    ...
    methods = {
        loadOptions: {
            ...
            async getModels(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
                ...
                const credentials = await this.getCredentials('pliegerApi');
    ...
    private static async getAccessToken(executeFunctions: any, credentials: any): Promise<string> {
        ...
        // 2. Check cache
        const cached = Plieger.tokenCache.get(cacheKey);
        ...
        try {
            ...
            // Save in the Map
            Plieger.tokenCache.set(cacheKey, {
                token: token,
                expiresAt: expiresAt,
            });
    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        if (credentials.otp) {
            ...
            accessToken = await Plieger.getAccessToken(this, credentials);
        }        
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                try {
                    ...
                    if (!credentials.otp) {
                        Plieger.tokenCache.delete(cacheKey);
                    }
