...
import { subsidieOperations, subsidieFields } from './descriptions/Subsidie.description';

export class Subsidie implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'Subsidiemanager',
        name: 'subsidie',
        icon: { light: 'file:subsidie.svg', dark: 'file:subsidie.svg' },
        group: ['transform'],
        version: 1,
        description: 'Interaction with Subsidie API',
        defaults: {
            name: 'Subsidie',
        },
        ...
        properties: [
            ...
            // ----------------------------------
            {
                ...
                options: [
                    ...
                    {
                        name: 'Subsidiemanager',
                        value: 'subsidie',
                    }
                ],
                default: 'subsidie', // Changed from assignments to subsidie to match the resource options
            },
            ...
            // Subsidie operations and fields
            ...subsidieOperations,
            ...subsidieFields,
        ],
    };
        ...
        loadOptions: {
            ...
            async getModels(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
                ...
                if (credentials.otp) {
                    ...
                    accessToken = await Subsidie.getAccessToken(this as any, credentials);
                }
    ...
    private static async getAccessToken(executeFunctions: any, credentials: any): Promise<string> {
        ...
        // 2. Check cache
        const cached = Subsidie.tokenCache.get(cacheKey);
        ...
        try {
            ...
            // Save in the Map
            Subsidie.tokenCache.set(cacheKey, {
                token: token,
                expiresAt: expiresAt,
            });
    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        if (credentials.otp) {
            ...
            accessToken = await Subsidie.getAccessToken(this, credentials);
        }        
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                try {
                    ...
                    if (!credentials.otp) {
                        Subsidie.tokenCache.delete(cacheKey);
                    }
