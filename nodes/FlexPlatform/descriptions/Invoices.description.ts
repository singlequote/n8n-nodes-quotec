...
export const invoicesFields: INodeProperties[] = [
    ...
    // ----------------------------------
    {
        ...
        description: 'Het ID van het item (UUID of nummer)',
    },
                ...
                values: [
                    {
                        ...
                        type: 'string',
                        default: '',
                        description: 'Veldnaam (bijv. customer_id, amount, status)',
                    },
                    {
                        displayName: 'Value',
                        name: 'value',
    ...
    // ----------------------------------
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'json',
                default: '{}',
                description: 'Voeg ruwe JSON filters toe (LET OP: Gebruik dubbele quotes!)',
            },
        ],
    },
